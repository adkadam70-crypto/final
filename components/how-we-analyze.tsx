    ...
    <details className="group bg-card border border-border rounded-3xl overflow-hidden">
      ...
      <div className="px-6 pb-6 space-y-5 text-xs text-muted-foreground leading-relaxed">
        ...
        <section>
          ...
          <ul className="space-y-1.5 list-disc list-inside">
            <li><strong className="text-foreground">Official rate:</strong> where a university or an official body publishes its own overall acceptance rate, we show that figure and name the source. We never change it. For the UK and Australia this is the nationally-published <em>offer rate</em> (from UCAS or VTAC) — an offer <em>is</em> the admission, so it means the same thing; whether you enrol is your choice.</li>
