    ...
    if (shaderRef.current) {
      ...
      try {
        shaderMount.current = new ShaderMount(
          ...
          {
            // Higher repetition = many thin, fast-blending stripes that read
            // as one continuous flowing glow. At 4, each stripe is wide
            // enough to show as a distinct bright band with a visible dark
            // gap next to it — a chunky, "broken up" ring instead of a
            // smooth one.
            u_repetition: 40,
            u_softness: 0.9,
            u_shiftRed: 0.3,
