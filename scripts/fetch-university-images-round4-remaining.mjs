// Same image-fetch pipeline as fetch-university-images-round3-new-schools.mjs,
// scoped to the full backlog of universities still missing an image (2,452 as
// of 2026-09-23), not just one session's new-school batch. Safe to re-run —
// it only ever selects rows where "imageUrl" IS NULL, so an interrupted run
// just picks up where it left off.
//
// Usage: node --env-file=.env.local scripts/fetch-university-images-round4-remaining.mjs
