...
const rows = await sql`SELECT id FROM universities WHERE name = 'OTH Regensburg' AND country = 'DE'`
...
await sql`
  ...
  VALUES (${id}, 'Engineering', 101, 'EduRank.org Citation-Based Overall Ranking 2026 — Germany', 'https://edurank.org/uni/regensburg-university-of-applied-sciences/', ${selectivityFromRank(101,369)}, ${NOTE})
`
