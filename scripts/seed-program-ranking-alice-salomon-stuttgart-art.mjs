...
const DATA = [
  ['Alice-Salomon-Fachhochschule für Sozialarbeit und Sozialpädagogik Berlin', 'Social Sciences', 168, 369, 'https://edurank.org/uni/alice-salomon-university-of-applied-sciences-berlin/'],
  ['Stuttgart State Academy of Art and Design', 'Arts', 150, 369, 'https://edurank.org/uni/stuttgart-state-academy-of-art-and-design/'],
]
let inserted = 0
