...
const DATA = [
  ['Fachhochschule Kaiserslautern', 'Engineering', 141, 369, 'https://edurank.org/uni/kaiserslautern-university-of-applied-sciences/rankings/'],
  ['Fachhochschule Erfurt', 'Science & Technology / Research', 213, 369, 'https://edurank.org/uni/erfurt-university-of-applied-sciences/'],
]
let inserted = 0
