...
const rows = await sql`SELECT id FROM universities WHERE name = 'SRH Berlin University of Applied Sciences' AND country = 'DE'`
...
await sql`
  ...
  VALUES (${id}, 'Business', 186, 'EduRank.org Citation-Based Overall Ranking 2026 — Germany', 'https://edurank.org/uni/srh-university-of-applied-sciences-berlin/', ${selectivityFromRank(186,369)}, ${NOTE})
`
