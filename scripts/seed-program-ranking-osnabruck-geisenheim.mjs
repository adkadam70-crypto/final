...
const DATA = [
  ['Osnabrück University of Applied Sciences', 'Science & Technology / Research', 162, 369, 'https://edurank.org/uni/osnabruck-university-of-applied-sciences/'],
  ['Hochschule Geisenheim University', 'Agriculture & Natural Resources', 229, 369, 'https://edurank.org/uni/hochschule-geisenheim-university/'],
]
let inserted = 0
