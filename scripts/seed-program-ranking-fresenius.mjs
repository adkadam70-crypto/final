...
const rows = await sql`SELECT id FROM universities WHERE name = 'Hochschule Fresenius' AND country = 'DE'`
...
await sql`
  ...
  VALUES (${id}, 'Science & Technology / Research', 215, 'EduRank.org Citation-Based Overall Ranking 2026 — Germany', 'https://edurank.org/uni/fresenius-university-of-applied-sciences/', ${selectivityFromRank(215,369)}, ${NOTE})
`
