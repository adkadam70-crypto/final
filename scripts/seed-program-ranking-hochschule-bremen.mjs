...
const rows = await sql`SELECT id FROM universities WHERE name = 'Hochschule Bremen' AND country = 'DE'`
const id = rows[0].id
...
const DATA = [
  ['Arts', 97, 'EduRank.org Citation-Based Subject Ranking 2026 — Art & Design (Germany)', 'https://edurank.org/art-design/de/'],
  ['Environmental Science & Sustainability', 100, 'EduRank.org Citation-Based Subject Ranking 2026 — Environmental Science (Germany)', 'https://edurank.org/environmental-science/de/'],
]
let inserted = 0
