...
const ENTRIES = [
  ...
  // --- tranche 2 additions (seed-universities-uk-2.mjs), CUG 2027 positions ---
  { name: 'Harper Adams University', rank: 48 },
  { name: 'Keele University', rank: 62 },
  { name: 'Aberystwyth University', rank: 65 },
  { name: 'Edge Hill University', rank: 70 },
  { name: 'University for the Creative Arts', rank: 75 },
  { name: 'Norwich University of the Arts', rank: 77 },
  { name: 'University of Hull', rank: 81 },
  { name: 'University of the West of England, Bristol', rank: 85 },
  { name: 'University of Chichester', rank: 86 },
  { name: 'Bath Spa University', rank: 93 },
  { name: 'Arts University Bournemouth', rank: 96 },
  { name: 'University of Chester', rank: 106 },
  { name: "St Mary's University, Twickenham", rank: 107 },
  { name: 'University of Sunderland', rank: 108 },
  { name: 'University of Worcester', rank: 111 },
  { name: 'University of Derby', rank: 116 },
  { name: 'Cardiff Metropolitan University', rank: 118 },
  { name: 'Teesside University', rank: 120 },
  { name: 'University of East London', rank: 121 },
  { name: 'University of Gloucestershire', rank: 122 },
  { name: 'Staffordshire University', rank: 123 },
  { name: 'Canterbury Christ Church University', rank: 124 },
  { name: 'University of South Wales', rank: 127 },
]
